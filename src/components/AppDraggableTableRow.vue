<template>
  <draggable :list="all_tasks" @end="reorderTasks">
    <tr
      class="flex justify-between items-center dark:bg-dark-100 bg-white-400 group dark:create-border-bottom dark:border-gray-300 border-solid border-b cursor-pointer border-white-200"
